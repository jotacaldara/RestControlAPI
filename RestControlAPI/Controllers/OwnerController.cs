...
namespace RestControlAPI.Controllers
{
    ...
    public class OwnerController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateReservationStatus(int id, [FromBody] UpdateStatusDto dto)
        {
            ...
            // FIX: was "Confirmada"/"Cancelada" — standard is "Confirmed"/"Canceled"
            if (dto.Status != "Confirmed" && dto.Status != "Canceled")
                return BadRequest(new { message = "Status inválido. Use 'Confirmed' ou 'Canceled'." });
